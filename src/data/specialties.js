...
export const specialties = [
    {
        ...
        description: 'Спеціальність "Інженерія програмного забезпечення" спрямована на підготовку висококваліфікованих фахівців у галузі розробки та підтримки програмного забезпечення. Студенти навчаються проектувати, розробляти, тестувати, впроваджувати та підтримувати програмні продукти, а також вивчають сучасні методології, технології та інструменти програмування.\n\nДізнатися більше про кафедру',
        programs: [
        ...
        careers: [
            {
                title: 'Web Developer',
                salary: '$600–900',
                description: 'Займається написанням застосунків, сайтів і окремих елементів, з використанням різних мов програмування (PHP, JS, JAVA та інші)',
            },
            {
                title: 'QA Tester',
                salary: '$500–700',
                description: 'Тестує готове програмне забезпечення на наявність багів та виправляє їх у разі, якщо дозволяють його фахові компетенції.',
            },
            {
                title: 'UX/UI Designer',
                salary: '$500–800',
                description: 'Спеціаліст, який займається проектуванням інтерфейсів користувача.',
            },
            {
                title: 'Business Analytic',
                salary: '$550–800',
                description: 'Фахівець, який відповідає за збір, аналіз та інтерпретацію складних наборів даних, щоб допомогти компаніям ухвалювати обґрунтовані рішення для ведення бізнесу.',
            },
        ],
        alumni: [
            {
